                    ...
                    <div className="row">
                        <div className="col-xl-6">
                            <div className="about-two__content">
                                ...
                                <p className="about-two__text">Welcome to our online learning center! Explore a diverse range of courses,
                                 expert instruction, and flexible learning options. Join us to expand your knowledge and achieve your
                                  goals.</p>
